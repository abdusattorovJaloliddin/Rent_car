    ...
    <div className="container mx-auto p-4">
      {singleCard && (
        <>
          ...
          />
          <p>
            <strong>Category:</strong> {singleCard.category}
          </p>
          <p>
            <strong>Fuel:</strong> {singleCard.fuel}
          </p>
          <p>
            <strong>Transmission:</strong> {singleCard.transmission}
          </p>
          <p>
            <strong>People:</strong> {singleCard.people}
          </p>
          <p>
            <strong>Price:</strong> {singleCard.price}
          </p>
